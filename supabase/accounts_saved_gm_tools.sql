-- PuckScope accounts + saved GM tools foundation
-- Run this in Supabase SQL Editor after enabling Email Auth / Magic Links.
...
create index if not exists gm_tool_saves_user_kind_idx on public.gm_tool_saves(user_id, kind, updated_at desc);
