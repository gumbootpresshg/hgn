...
<Link href="/community-pulse" className="hgn-card block p-5 hover:shadow-md"><div className="text-xs font-black uppercase text-hgnBlue">Polls</div><h2 className="mt-2 text-2xl font-black text-hgnNavy">Vote in Community Pulse</h2><p className="mt-2 text-sm text-slate-600">Vote in the current reader poll and see results after you vote.</p></Link>
