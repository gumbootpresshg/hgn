...
export const adminTools: AdminTool[] = [
  ...
  { href: "/admin/distribution", label: "News Distribution", description: "Check Google News, sitemaps, feeds, Search Console and IndexNow readiness.", group: "Platform", roles: ["publisher", "editor"], keywords: ["google news", "seo", "search console", "bing", "indexnow", "rss", "sitemap"], mobileRelevant: true },
