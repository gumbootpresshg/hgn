...
export const adminTools: AdminTool[] = [
  ...
  { href: "/admin/columns", label: "Columnists", description: "Add columnists and manage their public column pages, bios and visibility.", group: "Newsroom", roles: ["publisher", "editor"], keywords: ["columnists", "columns", "writers", "opinion"], priority: true, mobileRelevant: true },
