...
export const adminTools: AdminTool[] = [
  ...
  { href: "/admin/print-circulation", label: "Print Circulation", description: "Manage print subscribers, labels, issue distribution and returns.", group: "Audience", roles: ["publisher", "sales"], keywords: ["subscribers", "labels", "distribution", "returns", "print"], priority: true, mobileRelevant: false },
