import {
  publicBetaReadinessChecks,
  publicBetaReadinessScore,
} from "@/lib/public-beta-readiness"

export default function PublicBetaReadinessPage() {
  const score = publicBetaReadinessScore()
    ...
    <main className="mx-auto max-w-6xl space-y-8 px-6 py-10">
      <section className="rounded-3xl border bg-white p-8 shadow-sm">
        ...
        <p className="mt-3 max-w-3xl text-slate-600">
          A final reader-facing readiness board for sharing HGN publicly:
          homepage confidence, article mobile polish, submissions, and launch workflow.
        </p>
